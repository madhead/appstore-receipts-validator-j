...
import by.dev.madhead.utils.appstore_receipts_validator.mapper.InAppAutoRenewStatusDeserializer;
import by.dev.madhead.utils.appstore_receipts_validator.mapper.InAppCancellationReasonDeserializer;
import by.dev.madhead.utils.appstore_receipts_validator.mapper.InAppExpirationIntentDeserializer;
import by.dev.madhead.utils.appstore_receipts_validator.mapper.InAppPriceConsentStatusDeserializer;
...
public class InApp {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(quantity, inApp.quantity) &&
               ...
               Objects.equals(expirationDate, inApp.expirationDate) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(quantity, productId, transactionId, originalTransactionId, expirationDate, originalPurchaseDate, expiresDate, expirationIntent, inBillingRetryPeriod, trialPeriod, inIntroOfferPeriod, cancellationDate, cancellationReason, appItemId, versionExternalIdentifier, webOrderLineItemId, autoRenewStatus, autoRenewProductId, priceConsentStatus);
    }
